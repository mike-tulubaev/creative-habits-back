...
const clusterItem = {
  text: 'FOCUS MONONOVOUS is a detailed and dignified creative species that, like Novo Gregarious, travels streams and rivers in search of novel, unconstrained environments. Single-minded and precise, Focus Mononovous requires calm and quiet to focus its energy into growing a colorful, perfectly-formed bloom. Although many creative species can thrive in indoor environments, Focus Mononovous grows best in the wild, unconstrained and free. Those who find a Focus Mononovous in the wild should be careful not to distract it, otherwise it may have to start its flowering process over again. Individuals who are part of this species are capable of exploring deep into a subject, but when the creative well runs dry, Focus Mononovus should explore other projects that introduce fresh ideas and broaden their creative perspective.',
  scroll_img: path.join(__dirname, '..', '/images/focus_mononovous_scroll.png'),
  text_img: path.join(__dirname, '..', '/images/focus_mononovous_title.svg'),
  width: 571,
  height: 1014,
  x: 116,
  y: -11,
      ...
      },
      {
        ...
        stack: [
                ...
                [
                  {
                    table: {
                      ...
                      body: [
                        [
                          {
                            text: `${userInfo.percentage}% of Focus Mononovous's creative habits overlap with yours`,
                            font: 'GtAmericaMono',
                            italics: true,
          ...
          // Shared habits note
          {
            ...
            text: 'Habits with  are shared with Focus Mononovous',
            font: 'GtAmericaMono',
            italics: true,

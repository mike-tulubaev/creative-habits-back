...
const clusterItem = {
  text: 'SOCIALIS ADVENTUROUS is characterized by its many blooms that take flight to ride air currents in search of new landscapes. A highly-social creative species, Socialis Adventurous is found in habitats dense with others, its roots flowing out to collect a wide range of nutrients, the more the better. Like Yolo Chaotis, Socialis Adeventurous liberally spreads its energy across many blooms at once, knowing that even though not all of them will flourish, those blooms that do, will be strong and vivid. Those who would like to see the best of this creative species will need to rise early, because many Socialis Adventurous prefer to show their brightest colors in the morning. Individuals who are part of this species typically thrive in a team environment and are comfortable exploring high-risk ideas, but Socialis Adventurous should be mindful that others may be more cautious and need time alone to collect their ideas before collaborating.',
  scroll_img: path.join(__dirname, '..', '/images/socialis_adventurous_scroll.png'),
  text_img: path.join(__dirname, '..', '/images/socialis_adventurous_title.svg'),
  width: 908,
  height: 882,
  x: -39,
  y: 43,
      ...
      },
      {
        ...
        stack: [
                ...
                [
                  {
                    table: {
                      ...
                      body: [
                        [
                          {
                            text: `${userInfo.percentage}% of Socialis Adventurous's creative habits overlap with yours`,
                            font: 'GtAmericaMono',
                            italics: true,
          ...
          // Shared habits note
          {
            ...
            text: 'Habits with  are shared with Socialis Adventurous',
            font: 'GtAmericaMono',
            italics: true,

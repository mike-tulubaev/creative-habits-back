...
const clusterItem = {
  text: 'SOLO NOCTUS can be found in open terrain blooming under a wide-open night sky and will not thrive in constrained environments. Similar to Sui Inspira, this creative species grows from a bulb that contains everything it needs to succeed. Solo Noctus is tenacious and dedicated, waiting until conditions are perfect to put all its energy into growing a single, densely-petaled flower. A Sui Inspira does poorly in captivity, so those who want to see its fabled flower in person should be prepared to stay up late, because this creative species only blooms at night. Individuals who are part of this species thrive in unrestricted freedom and bloom on their own schedule, but should not limit their creativity to such a rare environment. When conditions aren’t perfect, Solo Noctus should embrace the ingenious solutions that can emerge from creative limits.',
